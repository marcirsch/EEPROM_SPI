...
HD_PWD='/home/marcell/vivado/RendszerArch/axi_spi/axi_spi.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_spi_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_spi_top.tcl
